...
\chapter*{Basic mathematical Concepts}
    ...
    \section*{Boolean Algebra}
        ...
        \begin{enumerate}
            ...
            \item Both $\overset{-}{x}$ and $x'$ are read as NOT x 
...
\chapter*{Cartesian Products and Relations}
    ...
    \end{definition}
    \text{A binary relation  from A to B is a set R of ordered pairs where the first element of}\\
    \text{each ordered pair comes from A and the second element comes from B}
